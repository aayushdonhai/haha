...
const REASONS: ReasonCard[] = [
  ...
  { id: 5, frontDoodle: "💤", bgColor: "bg-[#F4ECF7]", reason: "The late-night texts where we fall asleep talking to each other." },
  ...
  { id: 15, frontDoodle: "🧁", bgColor: "bg-[#F4ECF7]", reason: "How patient you are with me." },
  ...
  { id: 18, frontDoodle: "🍕", bgColor: "bg-[#FEF9E7]", reason: "The habit of always getting jealous." },
  { id: 19, frontDoodle: "📅", bgColor: "bg-[#E8F8F5]", reason: "Our shared countdown to September, planning every single detail." },
  { id: 20, frontDoodle: "♾️", bgColor: "bg-[#F4ECF7]", reason: "Because you are my world, and I can't wait to start our real-life story." },
];
